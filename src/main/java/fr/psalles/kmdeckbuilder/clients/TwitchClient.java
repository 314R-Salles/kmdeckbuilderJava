...
public class TwitchClient {
    ...
    public String getBearerToken() {
        log.info("Api call : Auth Krosmaga");
        String url = "https://id.twitch.tv/oauth2/token";
        return client.makeCall(HttpMethod.POST, url, TwitchAuthResponse.class, "nope", getUrlEncodedHeaders()).getAccess_token();
    }
